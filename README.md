...
| **How do I connect the site to my JAM account?** |	To add SAP Jam functionality to your site, do the following: •	Ensure that the end user has an SAP Jam account. •	Set up your SAP HANA Cloud Platform account. For more information, see Collaborating Using SAP Jam. |
